    ...
    public class AesEngine
    {
        ...
        */
            ...
            uint x)
        {
            ...
            uint f4 = this.FFmulX(f2);
            uint f8 = this.FFmulX(f4);
            uint f9 = x ^ f8;
        ...
        */
            ...
            uint[,] KW)
        {
            ...
            {
                r0 = T0[this.C0 & 255] ^ this.Shift(T0[(this.C1 >> 8) & 255], 24) ^ this.Shift(T0[(this.C2 >> 16) & 255], 16) ^
                     this.Shift(T0[(this.C3 >> 24) & 255], 8) ^ KW[r, 0];
                r1 = T0[this.C1 & 255] ^ this.Shift(T0[(this.C2 >> 8) & 255], 24) ^ this.Shift(T0[(this.C3 >> 16) & 255], 16) ^
                     this.Shift(T0[(this.C0 >> 24) & 255], 8) ^ KW[r, 1];
                r2 = T0[this.C2 & 255] ^ this.Shift(T0[(this.C3 >> 8) & 255], 24) ^ this.Shift(T0[(this.C0 >> 16) & 255], 16) ^
                     this.Shift(T0[(this.C1 >> 24) & 255], 8) ^ KW[r, 2];
                r3 = T0[this.C3 & 255] ^ this.Shift(T0[(this.C0 >> 8) & 255], 24) ^ this.Shift(T0[(this.C1 >> 16) & 255], 16) ^
                     this.Shift(T0[(this.C2 >> 24) & 255], 8) ^ KW[r++, 3];
                this.C0 = T0[r0 & 255] ^ this.Shift(T0[(r1 >> 8) & 255], 24) ^ this.Shift(T0[(r2 >> 16) & 255], 16) ^
                     this.Shift(T0[(r3 >> 24) & 255], 8) ^ KW[r, 0];
                this.C1 = T0[r1 & 255] ^ this.Shift(T0[(r2 >> 8) & 255], 24) ^ this.Shift(T0[(r3 >> 16) & 255], 16) ^
                     this.Shift(T0[(r0 >> 24) & 255], 8) ^ KW[r, 1];
                this.C2 = T0[r2 & 255] ^ this.Shift(T0[(r3 >> 8) & 255], 24) ^ this.Shift(T0[(r0 >> 16) & 255], 16) ^
                     this.Shift(T0[(r1 >> 24) & 255], 8) ^ KW[r, 2];
                this.C3 = T0[r3 & 255] ^ this.Shift(T0[(r0 >> 8) & 255], 24) ^ this.Shift(T0[(r1 >> 16) & 255], 16) ^
                     this.Shift(T0[(r2 >> 24) & 255], 8) ^ KW[r++, 3];
            }
            ...
            uint[,] KW)
        {
            ...
            {
                r0 = Tinv0[this.C0 & 255] ^ this.Shift(Tinv0[(this.C3 >> 8) & 255], 24) ^ this.Shift(Tinv0[(this.C2 >> 16) & 255], 16) ^
                     this.Shift(Tinv0[(this.C1 >> 24) & 255], 8) ^ KW[r, 0];
                r1 = Tinv0[this.C1 & 255] ^ this.Shift(Tinv0[(this.C0 >> 8) & 255], 24) ^ this.Shift(Tinv0[(this.C3 >> 16) & 255], 16) ^
                     this.Shift(Tinv0[(this.C2 >> 24) & 255], 8) ^ KW[r, 1];
                r2 = Tinv0[this.C2 & 255] ^ this.Shift(Tinv0[(this.C1 >> 8) & 255], 24) ^ this.Shift(Tinv0[(this.C0 >> 16) & 255], 16) ^
                     this.Shift(Tinv0[(this.C3 >> 24) & 255], 8) ^ KW[r, 2];
                r3 = Tinv0[this.C3 & 255] ^ this.Shift(Tinv0[(this.C2 >> 8) & 255], 24) ^ this.Shift(Tinv0[(this.C1 >> 16) & 255], 16) ^
                     this.Shift(Tinv0[(this.C0 >> 24) & 255], 8) ^ KW[r--, 3];
                this.C0 = Tinv0[r0 & 255] ^ this.Shift(Tinv0[(r3 >> 8) & 255], 24) ^ this.Shift(Tinv0[(r2 >> 16) & 255], 16) ^
                     this.Shift(Tinv0[(r1 >> 24) & 255], 8) ^ KW[r, 0];
                this.C1 = Tinv0[r1 & 255] ^ this.Shift(Tinv0[(r0 >> 8) & 255], 24) ^ this.Shift(Tinv0[(r3 >> 16) & 255], 16) ^
                     this.Shift(Tinv0[(r2 >> 24) & 255], 8) ^ KW[r, 1];
                this.C2 = Tinv0[r2 & 255] ^ this.Shift(Tinv0[(r1 >> 8) & 255], 24) ^ this.Shift(Tinv0[(r0 >> 16) & 255], 16) ^
                     this.Shift(Tinv0[(r3 >> 24) & 255], 8) ^ KW[r, 2];
                this.C3 = Tinv0[r3 & 255] ^ this.Shift(Tinv0[(r2 >> 8) & 255], 24) ^ this.Shift(Tinv0[(r1 >> 16) & 255], 16) ^
                     this.Shift(Tinv0[(r0 >> 24) & 255], 8) ^ KW[r--, 3];
            }
